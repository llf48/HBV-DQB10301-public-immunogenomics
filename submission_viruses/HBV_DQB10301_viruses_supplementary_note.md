...
For a one-step public-repository run, use `scripts/reproduce_all.ps1` on
Windows PowerShell or `scripts/reproduce_all.sh` on Unix-like systems.
...
- `docs/references/viruses_reference_library_70.csv`: PubMed-verified
  70-reference library with PMID, topic role, rationale, DOI, and formatted
  reference.
- `data/manual/viruses_reference_pmids_70.csv`: curated PMID list and evidence
  role mapping used to rebuild the reference library.

## Submission Tables

- `submission_viruses/tables/table_1_dataset_qc_summary.csv`
- `submission_viruses/tables/table_2_full_hla_dq_binder_summary.csv`
- `submission_viruses/tables/supplementary_table_pairwise_fisher_tests.csv`
- `submission_viruses/tables/supplementary_table_dedup_sensitivity.csv`
- `submission_viruses/tables/supplementary_table_record_bootstrap.csv`
- `submission_viruses/tables/supplementary_table_stratified_sensitivity.csv`
- `submission_viruses/tables/supplementary_table_position_gap_summary.csv`
- `submission_viruses/tables/supplementary_table_iedb_epitope_overlap_summary.csv`
- `submission_viruses/tables/supplementary_table_method_sensitivity_recommended.csv`
- `submission_viruses/tables/supplementary_table_top_core_position_gaps.csv`
- `submission_viruses/tables/supplementary_table_reference_proteome_by_protein_allele.csv`
- `submission_viruses/tables/supplementary_table_region_counts.csv`
